      ...
      <div className="max-w-2xl mx-auto p-4 py-8">
        <div className="bg-base-300 rounded-xl p-6 space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-balance">Your profile information</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              ...
              <label
                ...
                className={`absolute bottom-0 right-0 bg-base-content hover:scale-105 p-2 rounded-full cursor-pointer transition-transform duration-200 ${
